...
export default function Skills() {
  return (
    <div className={skillscss.all_icons}>
      ...
      <img className={skillscss.icons} src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg" alt="react" />
      ...
      <img className={skillscss.icons} src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-plain.svg" alt="git" />
      <img className={skillscss.icons} src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-plain.svg" alt="node.js" />
      ...
      <img className={skillscss.icons} src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/heroku/heroku-plain.svg" alt="heroku" />
    </div>
  )
}